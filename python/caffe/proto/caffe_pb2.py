...
_LAYERPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='upsample_param', full_name='caffe.LayerParameter.upsample_param', index=58,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='bn_param', full_name='caffe.LayerParameter.bn_param', index=59,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='dense_image_data_param', full_name='caffe.LayerParameter.dense_image_data_param', index=60,
...
_LOSSPARAMETER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='normalize', full_name='caffe.LossParameter.normalize', index=3,
      number=2, type=8, cpp_type=7, label=1,
      has_default_value=True, default_value=True,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='class_weighting', full_name='caffe.LossParameter.class_weighting', index=4,
